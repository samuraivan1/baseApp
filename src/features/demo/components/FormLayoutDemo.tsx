    ...
    <div style={{ padding: 16 }}>
      ...
      <FormSection title={demoMessages.cargo} icon={faBox}>
        ...
        <div className="fs-row-span-2">
          <label style={{ fontWeight: 600 }}>{demoMessages.specialFeatures}</label>
        ...
        <Textarea rows={3} label={demoMessages.additionalInstructions} className="fs-row-span-2" />
      </FormSection>

      <FormSection title={demoMessages.transport} icon={faTruck}>
        <div>
          <label style={{ fontWeight: 600, display: 'block', marginBottom: 6 }}>{demoMessages.mode}</label>
      ...
      <FormSection title={demoMessages.confirmation} icon={faCheckCircle}>
        <div className="fs-row-span-2">
          <label><input type="checkbox" /> {demoMessages.acceptTerms}</label>
        </div>
